...
export default function Home({ t = {}, division = 'industrial', setDivision = () => {} }) {
  ...
  const safeT = {
    ...
    hero: t?.hero || { title: 'Building Tomorrow, Today.', subtitle: 'Industrial & Residential Turnkey Projects', description: 'From initial design to final handover, we deliver excellence and precision in every project across Europe.', industrial: 'Industrial', residential: 'Residential', buildDream: 'Build Your Dream' },
    about: t?.about || { residential: { title: 'Living the dream', description: 'Quality residences', microclaim: 'Excellence' }, industrial: { title: 'General Contractor', description: 'Projects built to last', microclaim: 'Efficiency' }, reach: 'European Reach', methods: 'Proven Methods', team: 'Expert Team', quality: 'Quality' },
    process: t?.process || { title: 'Our Process', description: 'Transparent and efficient', steps: { land: { title: 'Land', desc: 'Secure location' }, permits: { title: 'Permits', desc: 'Get approval' }, design: { title: 'Design', desc: 'Blueprint to life' }, supervision: { title: 'Supervision', desc: 'Quality control' }, handover: { title: 'Handover', desc: 'Final delivery' } } },
    technology: t?.technology || { title: 'Technology', challenge_title: 'Challenge', challenge_desc: 'Manual monitoring issues', solution_title: 'Solution', solution_desc: '4D BIM digital twin', feature_4dbim_title: '4D BIM', feature_4dbim_desc: 'Integrated tracking', feature_quality_title: 'Quality', feature_quality_desc: 'AI-powered', feature_future_title: 'Future', feature_future_desc: 'Smart tools', cta: 'Explore Technology' },
    bim_monitoring: t?.bim_monitoring || { title: 'BIM Monitoring', subtitle: '4D progress tracking', benefits: ['Reduce time', 'Early detection', 'Better control'] },
    projects: t?.projects || { title: 'Our Portfolio', industrial: ['Project 1', 'Project 2', 'Project 3'], residential: ['Villa 1', 'Apartment 2', 'Residence 3'] }
  };
