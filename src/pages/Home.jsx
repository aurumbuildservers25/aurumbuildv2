...
const SectionWrapper = ({ children, id, className = '' }) => (
  <motion.section
    ...
    style={{
      ...
      // ✅ correct calc — this was missing a closing ) earlier
...
export default function Home({ t = {}, division = 'industrial', setDivision = () => {} }) {
  // keep the theme attribute in sync
  useEffect(() => {
    if (division) {
  ...
  // Fallbacks so the page never crashes if some keys are missing
  const safeT = {
        ...
        >
          <motion.h1
            ...
            style={{
              ...
              textShadow:
                division === 'industrial' ? '0 2px 8px rgba(0,0,0,0.3)' : 'none'
            }}
          ...
          <motion.p
            ...
            style={{
              color: division === 'industrial' ? '#C9D1D9' : '#4A5568'
            }}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto mb-12 md:mb-16">
            {[
              {
                icon: Globe,
                label: safeT.about.reach,
                color: division === 'industrial' ? '#7FCF8A' : '#2C7A7B'
              },
              {
                icon: ShieldCheck,
                label: safeT.about.methods,
                color: division === 'industrial' ? '#7FCF8A' : '#2C7A7B'
              },
              {
                icon: Users,
                label: safeT.about.team,
                color: '#8B5CF6'
              },
              {
                icon: Star,
                label: safeT.about.quality,
                color: division === 'industrial' ? '#FFB833' : '#8B6914'
              }
            ].map((item) => (
            ...
            <div className="relative">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-x-4 gap-y-8 md:gap-6 relative z-10">
                {[
                  {
                    icon: MapPin,
                    title: safeT.process.steps.land.title,
                    description: safeT.process.steps.land.desc,
                    step: 1
                  },
                  {
                    icon: FileCheck,
                    title: safeT.process.steps.permits.title,
                    description: safeT.process.steps.permits.desc,
                    step: 2
                  },
                  {
                    icon: HardHat,
                    title: safeT.process.steps.design.title,
                    description: safeT.process.steps.design.desc,
                    step: 3
                  },
                  {
                    icon: Users,
                    title: safeT.process.steps.supervision.title,
                    description: safeT.process.steps.supervision.desc,
                    step: 4
                  },
                  {
                    icon: KeyRound,
                    title: safeT.process.steps.handover.title,
                    description: safeT.process.steps.handover.desc,
                    step: 5
                  }
                ].map((step, index) => (
                  <div
      ...
      >
        <div className="max-w-screen-xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <p
              className="text-lg"
              style={{ color: division === 'industrial' ? '#7FCF8A' : '#2C7A7B' }}
            >
          ...
          >
            <h3 className="text-xl font-semibold mb-2">
              {safeT.technology.challenge_title}
            </h3>
            <p
            ...
            <h3 className="text-xl font-semibold mb-2">
              {safeT.technology.solution_title}
            </h3>
            <p
              className="text-sm"
              style={{ color: division === 'industrial' ? '#C9D1D9' : '#4A5568' }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {[
              {
                icon: Cpu,
                title: safeT.technology.feature_4dbim_title,
                text: safeT.technology.feature_4dbim_desc
              },
              {
                icon: BarChart4,
                title: safeT.technology.feature_quality_title,
                text: safeT.technology.feature_quality_desc
              },
              {
                icon: Sparkles,
                title: safeT.technology.feature_future_title,
                text: safeT.technology.feature_future_desc
              }
            ].map((f, index) => (
              <motion.div
                key={f.title}
                ...
                style={{
                  backgroundColor:
                    division === 'industrial' ? '#1B2A3A' : '#F7F7F5',
                  borderColor:
                    division === 'industrial'
                      ? 'rgba(255,255,255,0.06)'
                      : 'rgba(36,50,75,0.08)'
          ...
          <div
            className="max-w-3xl mx-auto rounded-2xl p-5 md:p-6 border-2 shadow-xl"
            style={{
              backgroundColor:
                division === 'industrial' ? '#132132' : 'rgba(247,247,245,0.90)',
              borderColor:
                division === 'industrial'
                  ? 'rgba(127,207,138,0.30)'
                  : 'rgba(44,122,123,0.30)'
            }}
          >
            <h3
